...
study_path = "/Users/yifan/Desktop/christmas_work/BrainMap/func424/func424_exp.txt"
...
study_id_list = BrainMap_info["study_id"].tolist() #length: 12839
study_id_unique = sorted(list(set(study_id_list))) # unique and ascening list
n_study = len(study_id_unique) #2676
...
for study_id in study_id_unique:
    ...
    study_df = BrainMap_info[BrainMap_info['study_id'] == study_id]
...
foci_path = "/Users/yifan/Desktop/christmas_work/BrainMap/func424/func424_mni.txt"
...
print(foci_df)
print(foci_df.shape)
foci_df.to_csv("BrainMap.csv",index=False)
